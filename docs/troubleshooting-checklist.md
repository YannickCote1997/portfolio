...
# ✅ 2) Comment tu t’en sers en entrevue (phrase magique)
Quand ils te demandent :

> “Comment tu diagnostiques une panne ?”

Tu réponds :

> « Je travaille avec une checklist structurée. Je commence par mesurer l’impact, isoler si c’est local/réseau/service, puis je teste les dépendances comme DNS/DHCP/SSL. J’ai d’ailleurs une documentation standard que j’utilise, je peux vous la montrer dans mon portfolio. »

💥 **Là tu passes en mode pro.**

---

# ✅ 3) Ajouter ce lien dans ton portfolio (bonus)
Dans `projects.html`, ajoute dans la section projets ou au bas :

```html
<section class="section">
  <div class="card">
    <h2>Documentation – Runbooks / Troubleshooting</h2>
    <p class="small">
